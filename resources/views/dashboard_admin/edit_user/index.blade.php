            ...
            <div class="grid grid-cols-2 gap-4">
                <div class="form-control">
                    ...
                    <input type="text" name="NPM" id="NPM"
                        class="input input-bordered text-black-2 bg-white w-full" value="{{ $data->NPM }}" required>
                </div>
                <div class="form-control">
                    <label for="nama" class="text-black-2 dark:text-white mb-2">Nama</label>
                    <input type="text" name="nama" id="nama"
                        class="input bg-white text-black-2 input-bordered w-full" value="{{ $data->nama }}" required>
                </div>
                <div class="form-control">
                    <label for="alamat" class="text-black-2 dark:text-white mb-2">Alamat</label>
                    <input type="text" name="alamat" id="alamat"
                        class="input input-bordered text-black-2 bg-white w-full" value="{{ $data->alamat }}" required>
                </div>
                <div class="form-control">
                    <label for="no_telepon" class="text-black-2 dark:text-white mb-2">No Telepon</label>
                    <input type="text" name="no_telepon" id="no_telepon"
                        class="input input-bordered text-black-2 bg-white w-full" value="{{ $data->no_telepon }}" required>
                </div>
                <div class="form-control">
                    ...
                    <input type="text" name="asal_instansi" id="asal_instansi"
                        class="input input-bordered text-black-2 bg-white w-full" value="{{ $data->asal_instansi }}"
                        required>
                </div>
                <div class="form-control col-span-2 flex items-center justify-center mt-5">
                    <button type="submit"
                        class="btn w-full lg:w-auto bg-blue-400 hover:bg-blue-300  dark:bg-black text-white">Simpan</button>
                </div>
            </div>
        </form>
    </div>
