...
@section('content')
    ...
    <div class="p-6 grid grid-cols-1 lg:grid-cols-3 gap-6">
        ...
        <div class="col-span-3 bg-yellow-100 p-4 rounded-lg shadow-md flex items-center">
            ...
            <p class="ml-4 text-yellow-800 font-semibold">Anda Belum Melakukan Presensi!! Mohon untuk segera melakukan
                Presensi
        ...
        <div role="alert" class="alert alert-warning flex col-span-3 ">
            ...
            <span class="ml-2">Warning: Anda Belum Melakukan Presensi!! Mohon untuk segera melakukan Presensi sebelum
                batas
                waktu.</span>
        </div>
