...
<button class=" bg-white dark:bg-slate-800" onclick="my_modal_4.showModal()">open modal</button>
<dialog id="my_modal_4" class="modal">
  <div class="modal-box w-11/12 max-w-5xl  bg-white dark:bg-slate-800">
    <form action="#">
        <div class="p-6.5">
          <div class="mb-4.5">
            <label
    ...
    <div class="modal-action">
      ...
      <form method="dialog">
        ...
        <button class="bg-white dark:bg-slate-800">Close</button>
      </form>
    </div>
  </div>
</dialog>
